    ...
    >
      <div className="container-narrow flex items-center justify-between h-16 sm:h-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <Link
            to="/auth"
            className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity"
          >
